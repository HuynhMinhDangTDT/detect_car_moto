...
addxmlpath = parentpath + 'transport_dataset/validation/annotations' #"Directory path with XML files"
addimgpath = parentpath + 'transport_dataset/validation/images' #"Directory path with IMG files"
# addxmlpath = parentpath + 'transport_dataset/train/annotations' #"Directory path with XML files"
# addimgpath = parentpath + 'transport_dataset/train/images' #"Directory path with IMG files"
outputpath = parentpath + 'labels' #"output folder for yolo format"
classes_txt = './transport_classes.txt' #"File containing classes"
